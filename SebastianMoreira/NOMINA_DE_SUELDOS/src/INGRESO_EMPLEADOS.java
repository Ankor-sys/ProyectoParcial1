...
DefaultTableModel model = new DefaultTableModel();
    ...
    public INGRESO_EMPLEADOS() {
        ...
        model.addColumn("DEVENGADOS");
        model.addColumn("IGSS");
        model.addColumn("ISR");
    ...
    private void initComponents() {
        ...
        txtOtrosDevengados = new javax.swing.JTextField();
        ...
        tblPlanilla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "NOMBRE", "PUESTO", "SALARIO", "SUELDO EXTRA", "BONIFICACION", "COMISIONES", "OTROS", "DEVENGADO", "IGSS", "ISR", "ANTICIPOS", "DESC. JUDICIALESl", "OTROS", "DESCUENTOS", "TOTAL"
            }
        ));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txtBonificaciones, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtComisiones, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtOtrosDevengados, javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtOtrosDescuentos, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(131, 131, 131)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(17, 17, 17)
                        .addComponent(txtOtrosDevengados, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void tbnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnGuardarActionPerformed
          ...
          float fltSalarioOrdinario, fltSalarioExtraordinario, fltBonificaciones,
                fltComisiones, fltOtrosDevengados, fltTotalDevengados;
        float fltIgss, fltIsr, fltAnticipos, fltDescuentosJudiciales, fltOtrosDescuentos, fltTotalDescuentos, fltTotalLiquido;
        
        fltSalarioOrdinario = Float.parseFloat(txtSalarioOrdinario.getText());
        fltSalarioExtraordinario = Float.parseFloat(txtSalarioExtraordinario.getText());
        fltBonificaciones= Float.parseFloat(txtBonificaciones.getText());
        fltComisiones = Float.parseFloat(txtComisiones.getText());
        fltOtrosDevengados = Float.parseFloat(txtOtrosDevengados.getText());
        fltTotalDevengados = fltSalarioOrdinario + fltSalarioExtraordinario
                + fltBonificaciones + fltComisiones + fltOtrosDevengados;
        
        if (fltTotalDevengados >= 6000) {
            if (fltTotalDevengados>=7500) {
                if (fltTotalDevengados>=9000) {
                    fltIgss = fltTotalDevengados *0.0483f;
                    fltIsr = fltTotalDevengados * 0.08f;
                }
                else{
                 fltIgss = fltTotalDevengados *0.0483f;
                 fltIsr = fltTotalDevengados * 0.6f;
                }
               
            }
            else{
            fltIgss = fltTotalDevengados *0.0483f;
            fltIsr = fltTotalDevengados * 0.05f;
            }
        }
        else{
        fltIgss = fltTotalDevengados *0.0483f;
        ...
        fltAnticipos = Float.parseFloat(txtAnticipos.getText());
        fltDescuentosJudiciales = Float.parseFloat(txtDescuentosJudiciales.getText());
        fltOtrosDescuentos = Float.parseFloat(txtOtrosDescuentos.getText());
        fltTotalDescuentos = fltIgss+fltIsr+fltAnticipos+fltDescuentosJudiciales+fltOtrosDescuentos;
        
        fltTotalLiquido = fltTotalDevengados - fltTotalDescuentos;
        
        
        String []Agregar = new String [18];
        Agregar[0]=txtCodigo.getText();
        Agregar[1]=txtNombre.getText();
        Agregar[2]=txtPuesto.getText();
        Agregar[3]=Float.toString(fltSalarioOrdinario);
        Agregar[4]=Float.toString(fltSalarioExtraordinario);
        Agregar[5]=Float.toString(fltBonificaciones);
        Agregar[6]=Float.toString(fltComisiones);
        Agregar[7]=Float.toString(fltOtrosDevengados);
        Agregar[8]=Float.toString(fltTotalDevengados);
        Agregar[9]=Float.toString(fltIgss);
        Agregar[10]=Float.toString(fltIsr);
        Agregar[11]=Float.toString(fltAnticipos);
        Agregar[12]=Float.toString(fltDescuentosJudiciales);
        Agregar[13]=Float.toString(fltOtrosDescuentos);
        Agregar[14]=Float.toString(fltTotalDescuentos);
        Agregar[15]=Float.toString(fltTotalLiquido);
    ...
    private javax.swing.JTextField txtOtrosDevengados;
